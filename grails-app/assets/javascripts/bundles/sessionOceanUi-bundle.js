...
;// CONCATENATED MODULE: ./src/main/js/sessionOcean/SessionOceanUi.svelte
/* src/main/js/sessionOcean/SessionOceanUi.svelte generated by Svelte v3.29.7 */
...
class SessionOceanUi extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { sessionId: 0 });
	}
}
...
/* harmony default export */ const SessionOceanUi_svelte = (SessionOceanUi);

;// CONCATENATED MODULE: ./src/main/js/sessionOceanUi.js
...
let containers = window.$(".SessionOceanUiContainer").each(function (index) {
    ...
    const sessionOceanUi = new SessionOceanUi_svelte({
        target: this,
        props: {
            sessionId: sessionId
        }
