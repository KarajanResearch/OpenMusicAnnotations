...
<asset:javascript src="howler.js-2.1.2/dist/howler.js" />
...
<div>
    ...
    <div>
        ...
        <!-- spectrogram:
        https://github.com/miguelmota/spectrogram/blob/master/example/scripts/main.js
        ...
        <script type="application/javascript">
            ...
            var sound = new Howl({
                src: ["${  createLink(controller: 'recording', action: 'getAudioFile', id: recording.id) }"],
                format: ["mp3", "flac", "wav"],
                autoplay: true,
                loop: true,
                volume: 0.5,
