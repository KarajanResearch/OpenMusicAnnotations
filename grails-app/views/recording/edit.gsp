    ...
    <body>
        ...
        <div id="edit-recording" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.recording}" method="PUT">
                ...
                <p>
                    By interpretation we mean "the way the music was played" and use attributes like "conducted by Karajan". Use Search or   <g:link class="create" controller="interpretation" action="create">add interpretation</g:link>
                </p>
